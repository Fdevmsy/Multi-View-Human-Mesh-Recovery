...
CMD="python -m src.main --d_lr 1e-4 --e_lr 1e-5 --log_img_step=1000 --pretrained_model_path=${PRETRAINED} --data_dir=${DATA_DIR} --e_loss_weight=60. --batch_size=8 --use_3d_label=0 --e_3d_weight=60. --datasets=mpi_inf_3dhp --epoch=75 --log_dir=logs"
